...
public class CustomerSendOtp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterCode = (EditText)findViewById(R.id.customerOtpField);
        txt = (TextView)findViewById(R.id.customerTextOtp);
        resend = (Button)findViewById(R.id.customerResendOtpBtn);
        verify = (Button)findViewById(R.id.customerVerifyOtpBtn);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()) {
                            startActivity(new Intent(CustomerSendOtp.this, customerDashboard.class));
                        } else {
                            ReusableCodes.ShowAlert(CustomerSendOtp.this, "Error",task.getException().getMessage());
                        }
                    }
                });
