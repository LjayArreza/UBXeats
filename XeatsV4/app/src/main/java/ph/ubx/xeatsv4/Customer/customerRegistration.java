...
public class customerRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fname = (TextInputLayout)findViewById(R.id.customerRegFirstName);
        Lname = (TextInputLayout)findViewById(R.id.customerRegLastName);
        Email = (TextInputLayout)findViewById(R.id.customerRegEmail);
        Pass = (TextInputLayout)findViewById(R.id.customerRegPassword);
        Cpass = (TextInputLayout)findViewById(R.id.customerRegConfirmPassword);
        Mobile = (TextInputLayout)findViewById(R.id.customerRegMobileNumber);
        LocalAddress = (TextInputLayout)findViewById(R.id.customerRegHouseNumer);
        Subd = (TextInputLayout)findViewById(R.id.customerRegSubd);
        ZipCode = (TextInputLayout)findViewById(R.id.customerRegZipCode);
        Statepin = (Spinner)findViewById(R.id.customerRegProvince);
        Citypin = (Spinner)findViewById(R.id.customerRegCity);

        signup = (Button)findViewById(R.id.customerRegSignUpButton);
        email = (Button)findViewById(R.id.customerRegSignUpWithEmail);
        phone = (Button)findViewById(R.id.customerRegSignUpWithPhone);

        Ccp = (CountryCodePicker)findViewById(R.id.customerRegCountryCode);
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if(task.isSuccessful()) {
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodes.ShowAlert(customerRegistration.this,"Error",task.getException().getMessage());
                                                        }
                                                    }
                                                });
                                            }
        ...
        email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(customerRegistration.this, customerLoginEmail.class));
                finish();
            }
        });
